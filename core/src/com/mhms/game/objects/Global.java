...
public class Global {
	...
	public Global(){ // A constructor outputs an object of this class, whereas methods a thing that the object can do.
		stateTime = 0f;
		batch = new SpriteBatch();
		menuBatch = new SpriteBatch();
	}
	
	public Global(int defaultScreenWidth, int defaultScreenHeight) { // it determines which constructor you call by the variables you pass through
		this.defaultScreenWidth = defaultScreenWidth; // this.default.. is the instance of that variable within that object.
